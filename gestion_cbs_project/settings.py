"""
Django settings for gestion_cbs_project project.
...
SECRET_KEY = 'django-insecure-9#ane@7)+l6qc3w07^u9(xxt2kmz0-zh0n$j#jtb#pc!@qmsad'
...
ROOT_URLCONF = 'gestion_cbs_project.urls'
...
WSGI_APPLICATION = 'gestion_cbs_project.wsgi.application'
...
STATIC_URL = 'static/'
# URL où rediriger après une connexion réussie (nous redirigeons vers la page d'accueil)
LOGIN_REDIRECT_URL = '/' 

# URL où les utilisateurs non authentifiés seront envoyés s'ils essaient d'accéder à une page protégée
...
# gestion_cbs_project/settings.py (à ajouter à la fin du fichier)
